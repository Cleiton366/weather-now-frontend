...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col md:mt-5 md:justify-center">
      <div className="flex flex-col md:flex-row  min-h-screen justify-center items-center">
        ...
        <div className="mt-10 md:ml-10">
          ...
          <h1 className="mt-5 px-10 md:w-[25rem] font-medium text-[12pt] md:text-[16pt]">Find out with Weather
            <span className="bg-clip-text text-transparent bg-gradient-to-b from-[#FBFBFB] to-[#8a8dd6]"> Now </span>
